...
AL_API ALvoid AL_APIENTRY alListenerf(ALenum param, ALfloat value)
{
    ...
    al_try
    {
        ...
        {
            case AL_GAIN:
                CHECK_VALUE(Context, value >= 0.0f && _finite(value));
...
AL_API ALvoid AL_APIENTRY alListener3f(ALenum param, ALfloat value1, ALfloat value2, ALfloat value3)
{
    ...
    al_try
    {
        ...
        {
            case AL_POSITION:
                CHECK_VALUE(Context, _finite(value1) && _finite(value2) && _finite(value3));
...
AL_API ALvoid AL_APIENTRY alListenerfv(ALenum param, const ALfloat *values)
{
    ...
    al_try
    {
        ...
        {
            case AL_ORIENTATION:
                CHECK_VALUE(Context, _finite(values[0]) && _finite(values[1]) &&
                                     _finite(values[2]) && _finite(values[3]) &&
