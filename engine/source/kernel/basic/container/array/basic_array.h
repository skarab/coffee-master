#ifndef _COFFEE_BASIC_CONTAINER_ARRAY_H_
#define _COFFEE_BASIC_CONTAINER_ARRAY_H_

#include "coffee_includes.h"
#include "kernel/basic/container/basic_container.h"
#include "kernel/basic/container/array/basic_array_template.h"
...
{
    //--------------------------------------------------------------------------------------------//
    /// Array supporting scalars and structs
    //--------------------------------------------------------------------------------------------//
    template< typename type > \
    class COFFEE_TEMPLATE_API Array : public Container< type >
    {
    public:
    ...
    #include "kernel/basic/container/array/basic_array.hpp"
}
}
#endif
